...
config (`defaults.ponytail_intensity`). The level governs how aggressively `/keel:reuse` climbs the ladder
and how hard the Simplicity reviewer in `/keel:code-review` cuts.
