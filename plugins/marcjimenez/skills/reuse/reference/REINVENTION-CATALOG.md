...
The four tiers to search, in this order — this repo → language stdlib → framework built-ins → installed
deps — are ladder rungs 2-5 in `CLIMB-THE-LADDER.md`. Report what you searched at each tier. If you genuinely searched all
